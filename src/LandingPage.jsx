    ...
    <>
      ...
      <div className='informacoes'>
        <div className="infoBox">
          <h2>Fale com quem melhor entende do assunto</h2>
          <p>Mais de 999 anos de experiência no mercado</p>
          <p>Atuando em mais de 999 processos judiciais</p>
          <p>Agilidade na prestação de serviço, honestidade e excelência</p>
        </div>
      ...
      <div className='servicos'>
        ...
        <div className="servBox">
          <h3>Horas Extras</h3>
          <p>Trabalha além do seu turno normal? Saiba que você tem direito a ser compensado por essas horas e por todas as taxas correspondentes.</p>
        </div>
      </div>
      ...
      <div className='rodape'>
        ...
        <h3>contato@smithadvocacia.com</h3>
        <h3>(00)12345-6790</h3>
          <div className="aviso">
            <h2>Aviso de página fictícia </h2>
            <p>Esta página e todos os dados contidos nela são fictícios, possui como único propósito demonstração de trabalho e habilidades, nenhum dado ou informação deve ser tomado como real.</p>
          </div>
      </div>
    </>
  );
